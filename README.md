...
- **Six templates** — Minimalist, Terminal (phosphor green mono), Magazine (serif + drop caps), Gradient (pitch-deck dream wash), Paper (graph-paper grid), and Council Signal (the household's own glassmorphic ember palette).
...
- **One-file export** — embedded CSS + JS. Open the downloaded `.html` anywhere; the deck just works.
